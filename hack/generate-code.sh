...
kube::codegen::gen_helpers "$PROJECT_ROOT" \
 ...
 kube::codegen::gen_openapi "$PROJECT_ROOT/apis" \
   ...
   --extra-pkgs "github.com/openmcp-project/landscaper/legacy-component-spec/bindings-go/apis/v2" \
...
"$MOCKGEN" "-destination=$PROJECT_ROOT/pkg/landscaper/registry/components/mock/resolver_mock.go" github.com/openmcp-project/landscaper/legacy-component-spec/bindings-go/ctf ComponentResolver
