...
require (
	...
	github.com/openmcp-project/landscaper/apis v1.0.1
	github.com/openmcp-project/landscaper/controller-utils v1.0.1
	github.com/openmcp-project/landscaper/legacy-component-cli v1.0.1
	github.com/openmcp-project/landscaper/legacy-component-spec/bindings-go v1.0.1
