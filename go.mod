...
require (
	...
	github.com/openmcp-project/landscaper/apis v1.3.1
	github.com/openmcp-project/landscaper/controller-utils v1.3.1
	github.com/openmcp-project/landscaper/legacy-component-cli v1.3.1
