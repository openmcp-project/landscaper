...
```
go get github.com/openmcp-project/landscaper/legacy-component-spec/bindings-go
```
...
import (
    ...
    "github.com/openmcp-project/landscaper/legacy-component-spec/bindings-go/apis/v2"
